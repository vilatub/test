#!/usr/bin/env python3
"""
Phase 5 Expansion: Advanced Clustering Methods
DBSCAN, Hierarchical Clustering, UMAP visualization
"""
...
output_path = '/home/user/test/notebooks/phase5_anomaly_patterns/02_advanced_clustering.ipynb'
with open(output_path, 'w', encoding='utf-8') as f:
    json.dump(notebook, f, ensure_ascii=False, indent=1)

print(f'✅ Advanced Clustering notebook created: {output_path}')
